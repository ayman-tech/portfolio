export interface Profile {
  ...
  website: string; linkedin: string; github: string; location: string;
}
export interface Project {
  name: string; tech: string[]; description: string; icon: string;
  status: 'Live' | 'Pre-Deployment'; product_link: string | null; link: string | null;
}
export interface Experience {
  company: string; role: string; location: string; period: string; bullets: string[];
}
export interface Education {
  degree: string; school: string; period: string; courses: string[];
}
export type Skills = Record<string, { icon: string; items: string[] }>;
